...
async def about():
    ...
    return HTMLResponse(content="""<div class="uk-card uk-card-default" className="uk-card-body" style="background-color: {custom_colors[-1]}">
        <!-- Header Section -->
        ...
        <div class="uk-card-body">
            <div class="uk-grid-divider uk-child-width-expand uk-grid-small" data-uk-grid="true">
                ...
                <!-- Graph Section -->
                <div>
                    <dcc-graph config='{"displayModeBar": false}' id="investment_fig"
                               style="height: 150px"></dcc-graph>
                    <hr/>
