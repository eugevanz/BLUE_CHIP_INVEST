                    ...
                    html.Div(
                        **{
                            'data-src': 'https://oujdrprpkkwxeavzbaow.supabase.co/storage/v1/object/public/website_images'
                                        '/youssef-naddam-iJ2IG8ckCpA-unsplash_15_11zon.webp'},
                        **{'data-uk-img': 'true'},
                ...
                html.Div([
                    html.Div([
                        html.Div(
                            style={
                                'background-image':
                                    'url(https://oujdrprpkkwxeavzbaow.supabase.co/storage/v1/object/public/website_images'
                                    '/jurica-koletic-7YVZYZeITc8-unsplash_3_11zon.webp)',
                                'filter': 'grayscale(90%)'},
                            className='uk-height-medium uk-flex uk-flex-start uk-flex-middle uk-background-cover uk-background-center-center'),
                        html.Div([
                        ...
                        ], className='uk-card uk-card-small uk-card-body uk-overlay',
