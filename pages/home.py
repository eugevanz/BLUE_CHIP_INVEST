    ...
    html.Div([
        ...
        html.Div([
            ...
            *[html.Div([
            ...
            className='uk-child-width-expand@s uk-grid-collapse uk-grid-match uk-flex-middle',
            ...
            html.Div([
                ...
                html.Div([
                    html.Div([
                        html.Div([
                            html.Div([
                                html.Span(**{'data-uk-icon': 'icon: star'}, className='uk-text-warning uk-icon') for _
                                in
                                range(5)
                            ]),
                            html.P([
            ...
            html.Div([
                html.Div([
                    ...
                    *[html.Div([
                        html.Div([
                            html.Div(
                                style={'height': '320px', 'background-image': f'url({img})',
                                       'filter': 'grayscale(90%)'},
                                className='uk-background-cover'),
                            html.Div([
