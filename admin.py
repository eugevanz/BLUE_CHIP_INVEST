...
from utility_functions import get_clients, get_profile_picture_url, get_profile_first_name, get_profile_last_name, \
    ...
    get_profile_client_email, get_account_type, get_profile_created_at
            ...
            Div(
                Div(
                    Div(
                        ...
                        data_uk_img=True, style='width: 184px; height: 184px;',
                ...
                Div(
                    Div(get_profile_client_email(client), cls='uk-text-small uk-text-bolder'),
                    H1(
                    ...
                    Div(f'Member since {get_profile_created_at(client)}', cls='uk-text-small')
                ),
                data_uk_grid=True,
                cls='uk-grid-divider uk-flex-middle uk-child-width-expand@m'
            ),
            # Div(
            ...
            Div(
                ...
                Div(
                    ...
                    Div(
                        ...
                        slider_item_client_goals(),
                        slider_item_payouts(),
                        slider_item_advisors(),
            ...
            Ul(
                *[Li(
                    A(
                        ...
                        hx_get=f'/edit-client/{get_profile_client_id(client)}', hx_target='#page',
                        hx_push_url='/admin/', cls='uk-flex uk-flex-between'
                    ),
                    client_modal(client)
